...
sys.path.append("/home/syedmuhammadhammadirshad/Desktop/emertus_project/project_e_git/2303-capstone-group-E-outcome-predictions")
...
class TransformDataTestCase(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.end_points_list = ["appointment", "patient_councillor", "price_log", "councillor", "rating", "report"]
        self.data_frame ={}
        self.data_frames = load_data_frames(self.end_points_list, self.data_frame, self.spark)
        self.renamed_data_frames = df_rename(self.data_frames)
        self.merged_df = df_merge(self.renamed_data_frames)
        self.councilor_df =  self.merged_df.filter(self.merged_df["councillor_id"] == 1360)
    ...
    def test_duplicate_dataframes(self):
        ...
        dfs = {
        "patient_councillor_df": self.spark.createDataFrame([(10, 14), (12, 15), (13, 60)], ["councillor_id", "patient_id"]),
        "appointment_df": self.spark.createDataFrame([(70, 10), (18, 110), (19, 12)], ["appointment_id", "patient_id"]),
        }
        ...
        assert duplicates["patient_councillor_df"].columns == dfs["patient_councillor_df"].columns
        ...
        assert duplicates["patient_councillor_df"].collect() == dfs["patient_councillor_df"].collect()
    ...
    def test_rename_dfs(self):
        ...
        assert "patient_councillor_id" in self.renamed_data_frames["patient_councillor_df"].columns
    ...
    def test_merged_df(self):
        ...
        expected_columns = ['councillor_id', 'patient_id', 'rating_id', 
                            'rating_value', 'appointment_confirmed', 'amount_in_pkr', 'category', 
                            'appointment_updated']
    ...
    def test_data_processing(self):
        ...
        expected_data = [
            (1360,2967,2,2210,'Anxiety','2023-06-04T02:48:56.458Z','unsuccessful',1,1),
            (1360,2967,2,2210,'Depression','2023-06-04T02:48:56.458Z','unsuccessful',1,1),
            (1360,6272,5,2210,'Depression','2023-05-20T04:11:29.678Z','successful',1,1),
            (1360,6272,2,2210,'Depression','2023-05-20T04:11:29.678Z','unsuccessful',2,1),
            (1360,6272,4,2210,'Depression','2023-05-20T04:11:29.678Z','successful',3,1)
    ...
    def test_outcome_prediction_mean(self):
        ...
        expected_data = [
            (1360, 22.22, 50.0, 3683.33, 1.67, 3)
